...
export const Attribute = (props: TypeProps) => {
  ...
  return (
    <div className="idraw-studio-mod-attribute" style={style}>
      {selectedElementUUID ? (
        <div>
          <AttrForm fields={fields} onChange={onChange} />
        </div>
      ) : (
...
const AttrForm: React.FC<AttrFormProps> = ({ onChange, fields }) => (
  ...
  >
    <Row>
      <Col span="12">
        <Form.Item name="x" label="X" labelCol={{ span: 4 }}>
          <Input style={inputStyle} type="number" size="small" />
        </Form.Item>
      </Col>
      <Col span="12">
        <Form.Item name="y" label="Y" labelCol={{ span: 4 }}>
          <Input style={inputStyle} type="number" size="small" />
        </Form.Item>
      </Col>
    </Row>
    ...
    <Row>
      <Col span="12">
        <Form.Item name="w" label="W" labelCol={{ span: 6 }}>
          <Input style={inputStyle} type="number" size="small" />
        </Form.Item>
      </Col>
      <Col span="12">
        <Form.Item name="h" label="H" labelCol={{ span: 6 }}>
          <Input style={inputStyle} type="number" size="small" />
        </Form.Item>
      </Col>
    </Row>
